...
import com.sxkl.cloudnote.utils.MessageUtils;
import com.sxkl.cloudnote.utils.ServletHelp;
...
public class ArticleService {
	...
	public void addArticle(HttpServletRequest request) {
		...
		String contentFilted = FileUtils.saveHtmlImgToLocal(domain,content, savePath,user.getId());
