...
public class SpiderSchedule {
	...
	public void spider(){
		try {
			...
			redisTemplate.expire(Constant.NETARTICLE_KEY_IN_REDIS, 10, TimeUnit.HOURS);
			redisTemplate.expire(Constant.SIMPLE_NETARTICLE_KEY_IN_REDIS, 10, TimeUnit.HOURS);
