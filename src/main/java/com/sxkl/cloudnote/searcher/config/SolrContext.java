package com.sxkl.cloudnote.searcher.config;
...
public class SolrContext {
	...
	// 指定solr服务器的地址
	private final static String SOLR_URL = new String("http://119.27.181.136:9629/solr/");
	...
	public void addDoc() throws SolrServerException, IOException {
		...
		Builder builder = new HttpSolrClient.Builder(SOLR_URL + "cloudnote");
		HttpSolrClient solr = builder.build();
		solr.add(document);
		solr.commit();
		solr.close();
	...
	public void deleteDocumentById() throws Exception {
		// 选择具体的某一个solr core
		Builder builder = null;
		builder = new HttpSolrClient.Builder(SOLR_URL + "cloudnote");
	...
	public static void main(String[] args) throws Exception {
		SolrContext solr = new SolrContext();
